...
public class LASemanticoUtils {
    ...
    public static TabelaDeSimbolos.TipoLA verificarTipo(TabelaDeSimbolos tabela, LAParser.Parcela_unarioContext ctx) {
        ...
        /*
         * if (ctx.IDENT() != null) { String nomeVar = ctx.VARIAVEL().getText(); if
         * (!tabela.existe(nomeVar)) {
         * adicionarErroSemantico(ctx.VARIAVEL().getSymbol(), "Variável " + nomeVar +
         * " não foi declarada antes do uso"); return TabelaDeSimbolos.TipoLA.INVALIDO;
